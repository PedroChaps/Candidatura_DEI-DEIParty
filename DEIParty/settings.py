"""
Django settings for DEIParty project.
...
SECRET_KEY = 'django-insecure-232g*k0p65$9wxi8w92gzqh=n^r+8b&of%^hse-wn^+dda*i17'
...
WSGI_APPLICATION = 'DEIParty.wsgi.application'
